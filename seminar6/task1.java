...
public class task1 {
    ...
    public static void main(String[] args) {
        Notebook notebook1 = new Notebook("MSI", "6", "1024", "Windows", "black");
        Notebook notebook2 = new Notebook("Asus", "8", "1024", "Linux", "black");
        Notebook notebook3 = new Notebook("Aser", "4", "512", "Windows", "silver");
        Notebook notebook4 = new Notebook("HR", "8", "512", "Windows", "grey");
        Notebook notebook5 = new Notebook("MSI", "6", "1024", "Windows", "black");
     ...
     public static void sort(Map<String, String> criterias, Set<Notebook> notebooks) {
        ...
        if (temp.isEmpty()) {
           ...
           System.out.println("Мы вам может предложить: \n" + temp.toString());
        }
