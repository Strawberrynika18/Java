/* В файле содержится строка с данными. Напишите метод, который разберёт её на составные части и, используя StringBuilder создаст массив строк*/
...
public class task3 {
    ...
    public static void main(String[] args) {
        String strjsn_offile = getLineOffile("text3.jsn");
